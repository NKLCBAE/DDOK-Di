              ...
              <section className="myCalendarSelectedDateContainer">
                ...
                <CreateModal
                  ...
                  <div>
                    ...
                    <p className="myTodoInModalFont">
                      <p>알림{' '}</p>
                      <select onChange={getData} name='noticeTime' defaultValue=''>
                        {/* {alertTimeOpt.map(option => (
                          <option key={option.label} value={option.value} defaultValue={option.label}>{option.label}</option>))} */}
                          <option value='' disabled className="gressss">알림 시간을 설정해주세요</option>
  ...
  const putToDo = (e) => {
    axios(`https://i7a102.p.ssafy.io/api/todo/${userId}/${meeting.id}`, {
      ...
      data: {
        ...
        noticeTime: showUserToDo.noticeTime,
    ...
    <li className="myTodoContainerL">
      ...
      <div>
                    ...
                    <p className="myTodoInModalFont">
                      ...
                      <select onChange={getData} name='noticeTime' defaultValue=''>
                        {/* {alertTimeOpt.map(option => (
                          ...
                          <option value='' disabled className="ss">알림 시간을 설정해주세요</option>
                          <option value='5'>5분 전</option>
                          <option value="10">10분 전</option>
                          <option value="15">15분 전</option>
                          <option value="30">30분 전</option>
        ...
        <p>loading</p>
          ...
          <p className="myTodoSpanContentBottom">
            <p>알림{' '}</p>

            {userToDo.noticeTime === 5 ? "5분" : null}
            {userToDo.noticeTime === 10 ? "10분" : null}
            {userToDo.noticeTime === 15 ? "15분" : null}
            {userToDo.noticeTime === 30 ? "30분" : null}
            {userToDo.noticeTime === 60 ? "60분" : null}
            {userToDo.noticeTime === 1440 ? "1일" : null}
            {' '}전
          </p>
